...
namespace FSO.Common.Rendering.Framework
{
    ...
    public class _3DScene : _3DAbstract
    {
        ...
        public _3DScene(Graphics Device, ICamera camera) : base(Device)
        {
            this.Camera = camera;
        }
        ...
        /// </summary>
        /// <param name="Device">A GraphicsDevice instance used for rendering.</param>
        public _3DScene(Graphics Device) : base(Device)
        {
        }
        ...
        public override void PreDraw(Graphics device){
        }
        ...
        public override void DeviceReset(Graphics Device)
        {
            for (int i = 0; i < m_Elements.Count; i++)
