...
namespace FSO.LotView.Components
{
    public class RoofComponent : WorldComponent, IDisposable
    {
        ...
        public RoofComponent(Blueprint bp)
        {
            ...
            this.Effect = WorldContent.RoofEffect;
        ...
        {
            return new Vector3((x / 16f) * 3f, (z * pitch / 16f) * 3f + ((level - 1) * 2.95f * 3f) + blueprint.GetAltPoint(x / 16, y / 16) * 3, (y / 16f) * 3f);
        }
