...
namespace FSO.Client.UI.Controls
{
    ...
    public class UIButton : UIElement
    {
        ...
        public UIButton(Texture2D Texture)
        {
            ...
            ClickHandler =
                ListenForMouse(new Rect(0, 0, m_Width, m_Height), new UIMouseEvent(OnMouseEvent));
        ...
        public override void Draw(UISpriteBatch SBatch)
        {
            ...
            if (Width != 0)
            {
                ...
                /** left **/
                base.DrawLocalTexture(SBatch, m_Texture, new Rect(offset, vOffset, m_WidthDiv3, m_Height), Vector2.zero);

                /** center **/
                base.DrawLocalTexture(SBatch, m_Texture, new Rect(offset + m_WidthDiv3, vOffset, m_WidthDiv3, m_Height), new Vector2(m_WidthDiv3, 0), new Vector2( (Width - (m_WidthDiv3 * 2)) / m_WidthDiv3, 1.0f));

                /** right **/
                base.DrawLocalTexture(SBatch, m_Texture, new Rect(offset + (m_Width - m_WidthDiv3), vOffset, m_WidthDiv3, m_Height), new Vector2(Width - m_WidthDiv3, 0));
            }
            else
            {
                base.DrawLocalTexture(SBatch, m_Texture, new Rect(offset, vOffset, m_Width, m_Height), Vector2.zero);
            }
            ...
            if (m_Caption != null && m_CaptionStyle != null)
            {
                ...
                box.height -= 2;
                this.DrawLocalString(SBatch, m_Caption, Vector2.zero, m_CaptionStyle, box, Framework.TextAlignment.Center | Framework.TextAlignment.Right, Rect.zero, m_State);
            }
        }
        ...
        public override Rect GetBounds()
        {
            ...
            return m_Bounds;
            */
            return new Rect(0, 0, ClickHandler.Region.width, ClickHandler.Region.height); //ClickHandler.Region seems to be infinitely more trustworthy for this.
        }
    }
}
