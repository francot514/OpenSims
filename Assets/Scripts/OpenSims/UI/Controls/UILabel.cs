...
namespace FSO.Client.UI.Controls
{
    ...
    public class UILabel : UIElement
    {
        ...
        public new virtual Vector2 Size {
            ...
            set
            {
                m_Size = new Rect(0, 0, (int)value.x, (int)value.y);
            }
        }
        private Rect m_Size;
        ...
        public Framework.TextAlignment Alignment = Framework.TextAlignment.Center;
        ...
        public int _Alignment
        {
            set
            {
                ...
                {
                    case 3:
                        Alignment = Framework.TextAlignment.Center | Framework.TextAlignment.Middle;
                        break;
                }
            }
        }
