...
namespace FSO.Client.UI.Controls
{
    public class UIListBox : UIElement
    {
        ...
        {
            RowHeight = 15;
            MouseHandler = this.ListenForMouse(new Rect(0, 0, 10, 10), OnMouseEvent);
        }
...
#region Fields
        ...
        {
            var mouse = this.GetMousePosition(update);
        ...
        public override void Draw(UISpriteBatch batch)
        {
            ...
            for (var i = 0; i < VisibleRows; i++)
            {
                ...
                for (var x = 0; x < row.Columns.Length; x++)
                {
                    ...
                    var columnBounds = new Rect(0, 0, columnSpec.Width, RowHeight);
    ...
    {
        public int Width = 50;
        public Framework.TextAlignment Alignment = Framework.TextAlignment.Left;
    }
    ...
    public class UIListBoxColumnCollection : List<UIListBoxColumn>, UIAttributeParser
    {
        ...
        public void ParseAttribute(UINode node)
        {
            ...
            {
                var align = Framework.TextAlignment.Left;
                switch (alignments[i])
                {
                    case "2":
                        align = Framework.TextAlignment.Center;
                        break;
                }
